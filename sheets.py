...
class Sheet:
    ...
    def _parse_data(self, col_list, parsed_object, value, parsed_data, prop_params):
        ...
        :type col_list: list
        :param parsed_object: a template dict object with keys like 'base','iden','prop','molar_mass','cond','process' defined in the function, it's the object we want to make updates
        ...
        :raises: DataAssignmentError: exists cols like ":data", data is not applied to something
        """
