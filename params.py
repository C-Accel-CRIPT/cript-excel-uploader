params = {
    ...
    'material_iden': {
        ...
        'chem_repeat': {
            'names': ['chemical repeat', 'repeat unit'],
            'unit': None
        },
        'pubchem_cid': {
            'names': [],
    ...
    'material_prop': {
        ...
        'conc_mass': {
            'names': ['concentration mass'],
            'unit': 'g/ml'
        },
        'conc_molar': {
            'names': ['concentration molar'],
            'unit': 'M'
        },
        'conc_number': {
            'names': ['concentration number'],
            'unit': None
        },
        'conc_vol': {
            'names': ['concentration volume'],
            'unit': None
        },
        'contact_angle': {
            'names': [],
        ...
        'heat_vaporization_molar': {
            'names': ['enthalpy of vaporization', 'heat_vaporization', 'latent heat of vaporization', 'heat of evaporation'],
            'unit': 'J/mol'
        },
        ...
        'magnetic_sus_mass': {
            'names': ['magnetic susceptibility mass'],
            'unit': 'm**3/kg'
        },
        'magnetic_sus_molar': {
            'names': ['magnetic susceptibility molar'],
            'unit': 'm**3/mol'
        },
        'magnetic_sus_vol': {
            'names': ['magnetic susceptibility volume'],
            'unit': None
        },
        'molar_mass': {
            'names': [],
    ...
    'cond': {
        ...
        'light_power': {
            'names': ['light_power', 'light power'],
            'unit': 'watt'
        },
        'light_power_e': {
            'names': ['light_power_e', 'light power e'],
            'unit': 'watt'
        },
        'light_irradiance': {
            'names': ['light_irradiance', 'light irradiance'],
            'unit': 'mW/cm**2'
        },
        'light_wlength': {
            'names': ['light_wlength', 'light wlength'],
            'unit': 'nm'
        },
        'stirring': {
            'names': ['stirring'],
